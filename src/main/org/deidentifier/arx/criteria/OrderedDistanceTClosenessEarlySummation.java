 ...
 */
public class OrderedDistanceTClosenessEarlySummation extends TCloseness {
	 ...
	 * @param t
	 */
	public OrderedDistanceTClosenessEarlySummation(String attribute, double t) {
		super(attribute, t);
	}

	@Override
	public OrderedDistanceTClosenessEarlySummation clone() {
		return new OrderedDistanceTClosenessEarlySummation(this.getAttribute(), this.getT());
	}
